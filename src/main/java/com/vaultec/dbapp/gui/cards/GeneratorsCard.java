...
public class GeneratorsCard extends DefaultCard {
    ...
    public void init() {
        ...
        //---- button3 ----
        setFixed.setText("change status");
        this.add(setFixed, new TableLayoutConstraints(5, 3, 5, 3, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
    }
